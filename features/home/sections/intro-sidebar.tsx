    ...
    <aside className="space-y-4">
      <section className="overflow-hidden rounded-[18px] border border-[var(--line-soft)] bg-[rgba(22,27,35,0.9)] shadow-[0_16px_34px_rgba(0,0,0,0.22)]">
        ...
        <div className="space-y-3 p-4">
          <div className="rounded-[14px] border border-[rgba(255,255,255,0.05)] bg-white/[0.025] p-3.5">
            <p className="text-[0.76rem] font-semibold text-[var(--text-primary)]">Continue with Google</p>
            <p className="mt-1.5 text-[0.68rem] leading-5 text-[var(--text-muted)]">
              One account for secure, password-free member access.
            </p>
          </div>
          <LockdownAction
          ...
          >
            <MaterialIcon className="text-[16px]" name="account_circle" />
            Open Account
          </LockdownAction>
        </div>
      </section>
